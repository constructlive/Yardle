...
export default async function AdminDashboard() {
  ...
  return <>
    ...
    <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-4 2xl:grid-cols-7">
      ...
      <StatCard href="/admin/readings/list" label="Reading Progress" value={period ? `${readingsComplete} / ${requiredUnits.length}` : "0 / 0"} hint={period ? "meters read" : "No billing period"} icon={Gauge} tone="blue" />
      ...
      <StatCard href="/admin/landlord?filter=outstanding" label="Outstanding" value={formatMoney(totalOutstanding)} hint={bills.length ? "Unpaid and part paid" : "No bills"} icon={TrendingUp} tone="warning" />
