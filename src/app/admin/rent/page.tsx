...
export default async function RentDashboardPage() {
  ...
  return <>
    ...
    <section className="mb-6 grid gap-4 sm:grid-cols-2 xl:grid-cols-5">
      ...
      <StatCard label="Outstanding rent" value={formatMoney(outstanding)} hint="Due or overdue" icon={TrendingUp} tone="danger" href="/admin/rent/arrears" />
      ...
      <StatCard label="Needs attention" value={arrears.length} hint="Units due or in arrears" icon={CalendarClock} tone="warning" href="/admin/rent/checklist" />
    </section>
