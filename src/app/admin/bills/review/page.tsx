...
export default async function BillReviewPage() {
  ...
  return <>
    ...
    {periodReadings.length === 0 ? <section className="mb-6 rounded-2xl border border-amber-500/30 bg-amber-500/10 p-5 text-amber-100 shadow-soft"><h2 className="text-xl font-black">No readings complete</h2><p className="mt-2 text-sm font-bold text-amber-200/80">Enter readings for this period before reviewing bills.</p><div className="mt-4"><SecondaryButton href="/admin/readings">Enter readings</SecondaryButton></div></section> : null}
